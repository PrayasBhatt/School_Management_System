...
public class Main {
    public static void main(String[] args) {
        ...
        Subject s1 = new Subject(1, "Math", 100, "Mohan Pradhan", 40, 12);
        Subject s2 = new Subject(2, "Physics", 100, "Aakash Chandra Giri", 40, 12);
        Subject s3 = new Subject(3, "Java", 100, "Prayush Shrestha", 40, 12);

        subjects.add(s1);
        subjects.add(s2);
        subjects.add(s3);

        Bill b1 = new Bill(19500, 0, "2023/09/11");
        Bill b2 = new Bill(19500, 0, "2023/10/12");
        Bill b3 = new Bill(19500, 0, "2023/11/13");

        bills.add(b1);
        bills.add(b2);
        bills.add(b3);

        Student ss1 = new Student("Prayas Bhatt", 25053, 12, "Khumbila", c1, subjects, bills);
        Student ss2 = new Student("Shuvashis Gautam", 25055, 12, "Lobuche", c2, subjects, bills);
        Student ss3 = new Student("Shubham Devkota", 25056 , 12 , "Lobuche ", c3 , subjects, bills);
